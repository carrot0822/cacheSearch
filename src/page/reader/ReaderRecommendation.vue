<template>
  <div id="ReaderRecommendation" class="zyfPage ReaderCenter">
      ...
      <div class="flexLayoutRow">
        ...
        <div class="flexLayoutColumn">
          ...
          <el-form-item label="出版时间：" prop="time">
            <div class="block">
              <el-date-picker v-model="ruleForm.time" type="year" placeholder="选择年"></el-date-picker>
            </div>
          </el-form-item>
    ...
    <el-dialog :visible.sync="dialogVisible" width="10%" :before-close="handleClose">
    ...
    return {
      ...
      rules: {
        ...
        isbn: [
          ...
          { type: "number", message: "ISBN必须为数字值" }
        ],
  ...
  computed: {
    addData() {
      let newruleForm = {
        ...
        publishingTime: this.ruleForm.time.getFullYear(), // 格式转为2015
