  ...
  <div id="CurrentBorrowing" class="ReaderCenter zyfPage haveTablePage">
    ...
    <div style="margin-top: 5px" class="tableStyle">
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column prop="fkCardNumber" label="读者卡号"></el-table-column>
        ...
        <el-table-column prop="planReturnTime" :show-overflow-tooltip="true" label="预计归还时间"></el-table-column>
        <el-table-column label="已续借次数" prop="renewCount">
